...
impl Config {
    ...
    pub fn from_env() -> Result<Self> {
        Ok(Config {
            ...
            private_key: env::var("POLYMARKET_PK")
                .context("POLYMARKET_PK not found")?,
            clob_api_key: env::var("CLOB_API_KEY")
                .context("CLOB_API_KEY not found")?,
            clob_api_secret: env::var("CLOB_API_SECRET")
                .context("CLOB_API_SECRET not found")?,
            clob_passphrase: env::var("CLOB_PASSPHRASE")
                .context("CLOB_PASSPHRASE not found")?,
